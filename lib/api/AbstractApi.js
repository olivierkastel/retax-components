...
var AbstractApi = function () {
    ...
    _createClass(AbstractApi, [{
        ...
        value: function get(config) {
            return this._abstractMethod(_httpMethods.HTTP_METHODS.GET, config);
        }
    }, {
        key: "post",
        value: function post(config) {
            return this._abstractMethod(_httpMethods.HTTP_METHODS.POST, config);
        }
    }, {
        key: "put",
        value: function put(config) {
            return this._abstractMethod(_httpMethods.HTTP_METHODS.PUT, config);
        }
    }, {
        key: "delete",
        value: function _delete(config) {
            return this._abstractMethod(_httpMethods.HTTP_METHODS.DELETE, config);
        }
    }, {
        key: "_abstractMethod",
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                ...
                                _context2.t0 = _ApiError2.default;
        ...
        value: function _makeFetchConfig() {
            var _ref2 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { method: _httpMethods.HTTP_METHODS.GET },
                method = _ref2.method,
                body = _ref2.body,
...
AbstractApi = __decorate([(0, _inversify.injectable)(), __metadata('design:paramtypes', [Object, Object])], AbstractApi);
